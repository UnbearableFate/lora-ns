#!/bin/bash
# Training script for Llama-3.1-8B on MetaMathQA
# Distributed training on 8×H200 GPUs

set -e  # Exit on error

echo "================================================"
echo "Llama-3.1-8B MetaMathQA Training"
echo "================================================"
echo ""
echo "Configuration:"
echo "  - Model: meta-llama/Llama-3.1-8B"
echo "  - Dataset: MetaMathQA (~395K samples)"
echo "  - GPUs: 8×H200"
...
mkdir -p ./outputs/llama3.1_8b_metamath
...
echo "================================================"
echo ""
echo "Output location: ./outputs/llama3.1_8b_metamath/"
echo "Logs: ./outputs/llama3.1_8b_metamath/logs/"
echo ""
echo "To resume training from checkpoint:"
echo "  python train.py --config configs/Llama-3.1/llama3.1_8b_metamath.yaml \\"
echo "    --resume_from_checkpoint ./outputs/llama3.1_8b_metamath/checkpoint-XXXX"
echo ""
