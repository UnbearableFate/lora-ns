...
class PeftConfigMixin(PushToHubMixin):
    ...
    Args:
        peft_type (Union[[`~my_peft.utils.config.PeftType`], `str`]): The type of Peft method to use.
    """
    ...
    def from_peft_type(cls, **kwargs):
        ...
        from my_peft.mapping import PEFT_TYPE_TO_CONFIG_MAPPING
        ...
        #
        # from my_peft import AdaLoraConfig, PeftConfig
...
class PeftConfig(PeftConfigMixin):
    ...
    Args:
        peft_type (Union[[`~my_peft.utils.config.PeftType`], `str`]): The type of Peft method to use.
        task_type (Union[[`~my_peft.utils.config.TaskType`], `str`]): The type of task to perform.
